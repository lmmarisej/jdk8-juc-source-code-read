 ...
 * <b>Interfaces.</b>
 *
 * {@link lmmarise.util.concurrent.Executor} is a simple standardized
 * interface for defining custom thread-like subsystems, including
 * thread pools, asynchronous I/O, and lightweight task frameworks.
 * Depending on which concrete Executor class is being used, tasks may
 * execute in a newly created thread, an existing task-execution thread,
 * or the thread calling {@link lmmarise.util.concurrent.Executor#execute
 * execute}, and may execute sequentially or concurrently.
 *
 * {@link lmmarise.util.concurrent.ExecutorService} provides a more
 * complete asynchronous task execution framework.  An
 * ExecutorService manages queuing and scheduling of tasks,
 * and allows controlled shutdown.
 *
 * The {@link lmmarise.util.concurrent.ScheduledExecutorService}
 ...
 * function expressed as {@link lmmarise.util.concurrent.Callable},
 * the result-bearing analog of {@link java.lang.Runnable}.
 *
 * A {@link lmmarise.util.concurrent.Future} returns the results of
 * a function, allows determination of whether execution has
 * completed, and provides a means to cancel execution.
 *
 * A {@link lmmarise.util.concurrent.RunnableFuture} is a {@code Future}
 ...
 * <b>Implementations.</b>
 *
 * Classes {@link lmmarise.util.concurrent.ThreadPoolExecutor} and
 * {@link lmmarise.util.concurrent.ScheduledThreadPoolExecutor}
 * provide tunable, flexible thread pools.
 *
 * The {@link lmmarise.util.concurrent.Executors} class provides
 * factory methods for the most common kinds and configurations
 * of Executors, as well as a few utility methods for using
 * them.  Other utilities based on {@code Executors} include the
 * concrete class {@link lmmarise.util.concurrent.FutureTask}
 * providing a common extensible implementation of Futures, and
 * {@link lmmarise.util.concurrent.ExecutorCompletionService}, that
 * assists in coordinating the processing of groups of
 * asynchronous tasks.
 *
 * <p>Class {@link lmmarise.util.concurrent.ForkJoinPool} provides an
 * Executor primarily designed for processing instances of {@link
 * lmmarise.util.concurrent.ForkJoinTask} and its subclasses.  These
 ...
 * <h2>Queues</h2>
 *
 * The {@link lmmarise.util.concurrent.ConcurrentLinkedQueue} class
 * supplies an efficient scalable thread-safe non-blocking FIFO queue.
 * The {@link lmmarise.util.concurrent.ConcurrentLinkedDeque} class is
 * similar, but additionally supports the {@link java.util.Deque}
 * interface.
 *
 * <p>Five implementations in {@code java.util.concurrent} support
 * the extended {@link lmmarise.util.concurrent.BlockingQueue}
 * interface, that defines blocking versions of put and take:
 * {@link lmmarise.util.concurrent.LinkedBlockingQueue},
 * {@link lmmarise.util.concurrent.ArrayBlockingQueue},
 * {@link lmmarise.util.concurrent.SynchronousQueue},
 * {@link lmmarise.util.concurrent.PriorityBlockingQueue}, and
 * {@link lmmarise.util.concurrent.DelayQueue}.
 * The different classes cover the most common usage contexts
 * for producer-consumer, messaging, parallel tasking, and
 * related concurrent designs.
 *
 * <p>Extended interface {@link lmmarise.util.concurrent.TransferQueue},
 * and implementation {@link lmmarise.util.concurrent.LinkedTransferQueue}
 * introduce a synchronous {@code transfer} method (along with related
 * features) in which a producer may optionally block awaiting its
 * consumer.
 *
 * <p>The {@link lmmarise.util.concurrent.BlockingDeque} interface
 * extends {@code BlockingQueue} to support both FIFO and LIFO
 * (stack-based) operations.
 * Class {@link lmmarise.util.concurrent.LinkedBlockingDeque}
 * provides an implementation.
 *
 * <h2>Timing</h2>
 *
 * The {@link lmmarise.util.concurrent.TimeUnit} class provides
 ...
 * <ul>
 *
 * <li>{@link lmmarise.util.concurrent.Semaphore} is a classic concurrency tool.
 *
 * <li>{@link lmmarise.util.concurrent.CountDownLatch} is a very simple yet
 * very common utility for blocking until a given number of signals,
 * events, or conditions hold.
 *
 * <li>A {@link lmmarise.util.concurrent.CyclicBarrier} is a resettable
 * multiway synchronization point useful in some styles of parallel
 * programming.
 *
 * <li>A {@link lmmarise.util.concurrent.Phaser} provides
 * a more flexible form of barrier that may be used to control phased
 * computation among multiple threads.
 *
 * <li>An {@link lmmarise.util.concurrent.Exchanger} allows two threads to
 ...
 * {@link lmmarise.util.concurrent.ConcurrentHashMap},
 * {@link lmmarise.util.concurrent.ConcurrentSkipListMap},
 * {@link lmmarise.util.concurrent.ConcurrentSkipListSet},
 * {@link lmmarise.util.concurrent.CopyOnWriteArrayList}, and
 * {@link lmmarise.util.concurrent.CopyOnWriteArraySet}.
 ...
 * lmmarise.util.concurrent.ConcurrentHashMap} is "concurrent".  A
