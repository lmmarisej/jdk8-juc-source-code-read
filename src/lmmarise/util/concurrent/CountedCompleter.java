...
/**
 * A {@link lmmarise.util.concurrent.ForkJoinTask} with a completion action performed when
 ...
 * status (as reported in methods such as {@link lmmarise.util.concurrent.ForkJoinTask#isDone})
 * is arbitrary; this status changes only upon explicit invocations of
 * {@link #complete}, {@link lmmarise.util.concurrent.ForkJoinTask#cancel},
 * {@link lmmarise.util.concurrent.ForkJoinTask#completeExceptionally(Throwable)} or upon
 ...
 * (here, implicitly using the {@link lmmarise.util.concurrent.ForkJoinPool#commonPool()}).
 *
 * <pre> {@code
 ...
 * @author Doug Lea
 */
public abstract class CountedCompleter<T> extends lmmarise.util.concurrent.ForkJoinTask<T> {
     ...
     * {@link lmmarise.util.concurrent.ForkJoinTask#isCompletedAbnormally}.  The return value
