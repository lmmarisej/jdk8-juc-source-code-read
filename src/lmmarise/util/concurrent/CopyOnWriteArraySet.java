...
/**
 * A {@link java.util.Set} that uses an internal {@link lmmarise.util.concurrent.CopyOnWriteArrayList}
 ...
 *
 * @see lmmarise.util.concurrent.CopyOnWriteArrayList
 * @since 1.5
 * @author Doug Lea
...
public class CopyOnWriteArraySet<E> extends AbstractSet<E>
    ...
    private final lmmarise.util.concurrent.CopyOnWriteArrayList<E> al;

    /**
     * Creates an empty set.
     */
    public CopyOnWriteArraySet() {
        al = new lmmarise.util.concurrent.CopyOnWriteArrayList<E>();
    }
    ...
    public CopyOnWriteArraySet(Collection<? extends E> c) {
        if (c.getClass() == CopyOnWriteArraySet.class) {
            ...
            al = new lmmarise.util.concurrent.CopyOnWriteArrayList<E>(cc.al);
        }
        else {
