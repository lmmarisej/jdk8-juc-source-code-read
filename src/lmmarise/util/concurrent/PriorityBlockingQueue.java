...
/**
 * An unbounded {@linkplain lmmarise.util.concurrent.BlockingQueue blocking queue} that uses
...
public class PriorityBlockingQueue<E> extends AbstractQueue<E>
    implements lmmarise.util.concurrent.BlockingQueue<E>, java.io.Serializable {
     ...
     *  {@link BlockingQueue#offer(Object,long, lmmarise.util.concurrent.TimeUnit) BlockingQueue.offer})
     * @throws ClassCastException if the specified element cannot be compared
     *         with elements currently in the priority queue according to the
     *         priority queue's ordering
     * @throws NullPointerException if the specified element is null
