...
/**
 * An unbounded {@link lmmarise.util.concurrent.TransferQueue} based on linked nodes.
...
public class LinkedTransferQueue<E> extends AbstractQueue<E>
    ...
    private E awaitMatch(Node s, Node pred, E e, boolean timed, long nanos) {
        ...
        lmmarise.util.concurrent.ThreadLocalRandom randomYields = null; // bound if needed
     ...
     *  {@link lmmarise.util.concurrent.BlockingQueue#offer(Object,long,TimeUnit)
     *  BlockingQueue.offer})
     * @throws NullPointerException if the specified element is null
     */
    /**
