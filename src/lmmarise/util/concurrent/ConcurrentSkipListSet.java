 ...
 * a {@link lmmarise.util.concurrent.ConcurrentSkipListMap}.  The elements of the set are kept
...
public class ConcurrentSkipListSet<E>
    ...
    private final lmmarise.util.concurrent.ConcurrentNavigableMap<E,Object> m;
    ...
    public ConcurrentSkipListSet() {
        m = new lmmarise.util.concurrent.ConcurrentSkipListMap<E,Object>();
    }
    ...
    public ConcurrentSkipListSet(Comparator<? super E> comparator) {
        m = new lmmarise.util.concurrent.ConcurrentSkipListMap<E,Object>(comparator);
    }
    ...
    public ConcurrentSkipListSet(SortedSet<E> s) {
        m = new lmmarise.util.concurrent.ConcurrentSkipListMap<E,Object>(s.comparator());
        addAll(s);
    }
     ...
     * For use by submaps
     */
    ConcurrentSkipListSet(lmmarise.util.concurrent.ConcurrentNavigableMap<E,Object> m) {
        this.m = m;
    }
    ...
    public ConcurrentSkipListSet<E> clone() {
        try {
            ...
            clone.setMap(new lmmarise.util.concurrent.ConcurrentSkipListMap<E,Object>(m));
            return clone;
    ...
    public Spliterator<E> spliterator() {
        if (m instanceof lmmarise.util.concurrent.ConcurrentSkipListMap)
            return ((lmmarise.util.concurrent.ConcurrentSkipListMap<E,?>)m).keySpliterator();
        else
