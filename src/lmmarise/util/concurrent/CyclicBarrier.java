 ...
 * abnormally via {@link lmmarise.util.concurrent.BrokenBarrierException} (or
...
public abstract class CyclicBarrier{
    ...
    private int dowait(boolean timed, long nanos)
        throws InterruptedException, lmmarise.util.concurrent.BrokenBarrierException,
            lmmarise.util.concurrent.TimeoutException {
     ...
     * {@link lmmarise.util.concurrent.BrokenBarrierException} is thrown.
     *
     * <p>If any thread is {@linkplain Thread#interrupt interrupted} while waiting,
     * then all other waiting threads will throw
     * {@link lmmarise.util.concurrent.BrokenBarrierException} and the barrier is placed in the broken
     * state.
     *
     ...
     *         while waiting
     * @throws lmmarise.util.concurrent.BrokenBarrierException if <em>another</em> thread was
     ...
     */
    //等待所有的参与者到达barrier
    public int await() throws InterruptedException, lmmarise.util.concurrent.BrokenBarrierException {
        try {
            return dowait(false, 0L);
        } catch (lmmarise.util.concurrent.TimeoutException toe) {
     ...
     * interrupted status is cleared.
     *
     * <p>If the specified waiting time elapses then {@link lmmarise.util.concurrent.TimeoutException}
     ...
     * lmmarise.util.concurrent.BrokenBarrierException} and the barrier is placed in the broken
     * state.
     *
     * <p>If the current thread is the last thread to arrive, and a
     * non-null barrier action was supplied in the constructor, then the
     ...
     * @throws InterruptedException if the current thread was interrupted
     *         while waiting
     * @throws lmmarise.util.concurrent.TimeoutException if the specified timeout elapses.
    ...
    public int await(long timeout, TimeUnit unit)
        throws InterruptedException,
            lmmarise.util.concurrent.BrokenBarrierException,
            TimeoutException {
