 ...
 * @author Doug Lea
 */
public class DoubleAccumulator extends lmmarise.util.concurrent.atomic.Striped64 implements Serializable {
    ...
    public void accumulate(double x) {
        ...
        if ((as = cells) != null ||
            (r = Double.doubleToRawLongBits     // 写入主存中时，将double转为long
