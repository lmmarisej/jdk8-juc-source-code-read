...
/**
 * A reentrant mutual exclusion {@link lmmarise.util.concurrent.locks.Lock} with the same basic
 ...
 * }}</pre>
 *
 * <p>In addition to implementing the {@link lmmarise.util.concurrent.locks.Lock} interface, this
 ...
 * @author Doug Lea
 */
public class ReentrantLock extends lmmarise.util.concurrent.locks.AbstractQueuedSynchronizer implements lmmarise.util.concurrent.locks.Lock, java.io.Serializable {
    ...
    abstract static class Sync extends AbstractQueuedSynchronizer {
        ...
        /**
         * Performs {@link lmmarise.util.concurrent.locks.Lock#lock}. The main reason for subclassing
     ...
     * <ul>
     *
     * <li>If this lock is not held when any of the {@link lmmarise.util.concurrent.locks.Condition}
     * {@linkplain lmmarise.util.concurrent.locks.Condition#await() waiting} or {@linkplain
     * lmmarise.util.concurrent.locks.Condition#signal signalling} methods are called, then an {@link
