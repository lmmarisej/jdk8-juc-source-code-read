...
/**
 * An {@link lmmarise.util.concurrent.ExecutorService} that can schedule commands to run after a given
 ...
 * and {@link lmmarise.util.concurrent.ExecutorService} {@code submit} methods are scheduled
...
public interface ScheduledExecutorService extends ExecutorService {
    ...
    public lmmarise.util.concurrent.ScheduledFuture<?> schedule(Runnable command,
                                                                long delay, lmmarise.util.concurrent.TimeUnit unit);
     ...
     */
    public <V> lmmarise.util.concurrent.ScheduledFuture<V> schedule(Callable<V> callable,
                                                                    long delay, lmmarise.util.concurrent.TimeUnit unit);
